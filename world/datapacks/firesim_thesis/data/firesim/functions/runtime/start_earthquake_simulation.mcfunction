# Start earthquake sequence from lobby -> simulation zone.
scoreboard players set $mode fs_mode 2
...
title @a[tag=firesim_in_sim] subtitle {"text":"Quake starts in 5 seconds","color":"yellow"}
playsound minecraft:block.note_block.pling master @a[tag=firesim_in_sim] 26 -60 -11 1 0.9
