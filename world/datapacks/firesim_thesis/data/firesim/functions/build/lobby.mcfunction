...
# Fire simulation pedestal and button (detected at 0 65 4).
...
# Earthquake simulation pedestal and button (detected at 2 65 4).
setblock 2 64 4 deepslate_tiles
setblock 2 65 4 stone_button[face=floor,facing=north,powered=false]
setblock 2 64 3 polished_andesite
setblock 2 64 2 polished_andesite
...
summon minecraft:armor_stand 0 66 -1 {Tags:["firesim_lobby_text"],Invisible:1b,Marker:1b,NoGravity:1b,CustomNameVisible:1b,CustomName:'{"text":"Disaster Simulation","color":"red","bold":true}'}
summon minecraft:armor_stand 0 65 1 {Tags:["firesim_lobby_text"],Invisible:1b,Marker:1b,NoGravity:1b,CustomNameVisible:1b,CustomName:'{"text":"Left: Fire | Right: Earthquake","color":"white"}'}
